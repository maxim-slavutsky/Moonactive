...
class RedisConnector extends Base {
     ...
     * @param {?string} id - id of the message, if no id passed to the method, we use * in order to get autogenerated id
     * @param {...string[]} params - array of name-value pairs to be passed to Redis, for example - [name1, value1, name2, value2, ...]
     ...
     * @param {?Integer} count - if no count is provided, methos will attempt to read all available messages from queue
     * @param {string} streamName
     * @param {?string} messageId - if no message is is provided, method will read available messages from the beginning using special id ">"
     * @param {Function} callback
     */
    consumeFromQueue(groupName, consumerId, count, streamName, messageId, callback){
